...
export default class TOTOWActiveEffect extends foundry.documents.ActiveEffect {
   ...
   * @param {TOTOWActor} affected The actor affected by the status.
   * @param {TOTOWActor} source The actor imposing the status.
  ...
  prepareDerivedData() {
    ...
    Hooks.callAll("TALESOFTHEOLDWEST.prepareActiveEffectData", this);
  }
  ...
  _getDurationLabel(rounds, turns) {
    ...
    return game.i18n.localize("TALESOFTHEOLDWEST.ActiveEffect.Expired");
  }
