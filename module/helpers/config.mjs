...
TALESOFTHEOLDWEST.conditions = {
  starving: {
    id: "starving",
    name: "TALESOFTHEOLDWEST.Conditions.Starving",
    label: "TALESOFTHEOLDWEST.Conditions.Starving",
    img: "systems/talesoftheoldwest/assets/icons/starving.webp",
    tableNumber: 0,
  },
  dehydrated: {
    id: "dehydrated",
    name: "TALESOFTHEOLDWEST.Conditions.Dehydrated",
    label: "TALESOFTHEOLDWEST.Conditions.Dehydrated",
    img: "systems/talesoftheoldwest/assets/icons/water-flask.webp",
    resp: "",
    tableNumber: 0,
  },
  exhausted: {
    ...
    name: "TALESOFTHEOLDWEST.Conditions.Exhausted",
    label: "TALESOFTHEOLDWEST.Conditions.Exhausted",
    img: "systems/talesoftheoldwest/assets/icons/exhausted.webp",
    resp: "",
    tableNumber: 0,
  },
  freezing: {
    ...
    name: "TALESOFTHEOLDWEST.Conditions.Freezing",
    label: "TALESOFTHEOLDWEST.Conditions.Freezing",
    img: "systems/talesoftheoldwest/assets/icons/freezing.webp",
    resp: "",
    tableNumber: 0,
  },
  overwatch: {
    ...
    name: "TALESOFTHEOLDWEST.Conditions.Overwatch",
    label: "TALESOFTHEOLDWEST.Conditions.Overwatch",
    img: "systems/talesoftheoldwest/assets/icons/overwatch.webp",
    resp: "",
    tableNumber: 0,
  },
  heatstroke: {
    ...
    name: "TALESOFTHEOLDWEST.Conditions.Heatstroke",
    label: "TALESOFTHEOLDWEST.Conditions.Heatstroke",
    img: "systems/talesoftheoldwest/assets/icons/heatstroke.webp",
    resp: "",
    tableNumber: 0,
  },
  criticalinj: {
...
// TALESOFTHEOLDWEST.statusEffects = [
//   {
//     id: "starving",
//     name: "TALESOFTHEOLDWEST.Conditions.Starving",
//     label: "TALESOFTHEOLDWEST.Conditions.Starving",
