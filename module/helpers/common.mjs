...
const NAME = 'talesoftheoldwest';
const TITLE = 'Tales of the Old West';
...
export class COMMON {
	...
	static globals() {
		...
		// globalThis.game.talesoftheoldwest = {
		//   debug: {},
		// };
	}
	...
	static addAbstract(cls, key) {
		if (!globalThis.game.talesoftheoldwest.abstract) globalThis.game.talesoftheoldwest.abstract = {};
		globalThis.game.talesoftheoldwest.abstract[key] = cls;
	}
}
