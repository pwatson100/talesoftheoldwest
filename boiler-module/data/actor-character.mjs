...
export default class totowCharacter extends totowActorBase {
  static LOCALIZATION_PREFIXES = [
    ...super.LOCALIZATION_PREFIXES,
    'TALESOFTHEOLDWEST.Actor.Character',
  ];
  ...
  prepareDerivedData() {
    ...
    for (const key in this.abilities) {
      ...
      this.abilities[key].label =
        game.i18n.localize(CONFIG.TALESOFTHEOLDWEST.abilities[key]) ?? key;
    }
  }
