...
export class totowItemSheet extends api.HandlebarsApplicationMixin(sheets.ItemSheetV2) {
	...
	static PARTS = {
		form: {
			template: 'systems/talesoftheoldwest/templates/item/item-item-sheet.hbs',
		},
		// tabs: {
		...
		// },
		// description: {
		//   template: 'systems/talesoftheoldwest/templates/item/description.hbs',
		// },
		// attributesFeature: {
		//   template:
		//     'systems/talesoftheoldwest/templates/item/attribute-parts/feature.hbs',
		// },
		// attributesGear: {
		//   template: 'systems/talesoftheoldwest/templates/item/attribute-parts/gear.hbs',
		// },
		// attributesSpell: {
		//   template: 'systems/talesoftheoldwest/templates/item/attribute-parts/spell.hbs',
		// },
		// effects: {
